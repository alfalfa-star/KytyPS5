...
private:
	...
	bool          BUFFER_LOAD_D16(const Decoder::Instruction& inst);
	bool          BUFFER_STORE_D16(const Decoder::Instruction& inst);
	...
	bool DS_ATOMIC_BITWISE_B64(const Decoder::Instruction& inst, IR::ValueOpcode opcode);
	bool DS_ATOMIC_ADD_SUB_U64(const Decoder::Instruction& inst, bool subtract);
