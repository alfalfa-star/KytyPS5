...
constexpr MemoryOpcodeInfo MUBUF_OPCODE_LIST[] = {
    ...
    {0x26u, Opcode::BUFFER_LOAD_FORMAT_D16_HI_X, 1, 16, false, false, true},
    {0x27u, Opcode::BUFFER_STORE_FORMAT_D16_HI_X, 1, 16, false, false, true},
    {0x80u, Opcode::BUFFER_LOAD_FORMAT_D16_X, 1, 16, false, false, true},
    {0x81u, Opcode::BUFFER_LOAD_FORMAT_D16_XY, 2, 16, false, false, true},
    {0x82u, Opcode::BUFFER_LOAD_FORMAT_D16_XYZ, 3, 16, false, false, true},
    {0x83u, Opcode::BUFFER_LOAD_FORMAT_D16_XYZW, 4, 16, false, false, true},
    {0x84u, Opcode::BUFFER_STORE_FORMAT_D16_X, 1, 16, false, false, true},
    {0x85u, Opcode::BUFFER_STORE_FORMAT_D16_XY, 2, 16, false, false, true},
    {0x86u, Opcode::BUFFER_STORE_FORMAT_D16_XYZ, 3, 16, false, false, true},
    {0x87u, Opcode::BUFFER_STORE_FORMAT_D16_XYZW, 4, 16, false, false, true},
...
constexpr MemoryOpcodeInfo MTBUF_OPCODE_LIST[] = {
    ...
    {0x08u, Opcode::TBUFFER_LOAD_FORMAT_D16_X, 1, 16, false, true, true},
    {0x09u, Opcode::TBUFFER_LOAD_FORMAT_D16_XY, 2, 16, false, true, true},
    {0x0au, Opcode::TBUFFER_LOAD_FORMAT_D16_XYZ, 3, 16, false, true, true},
    {0x0bu, Opcode::TBUFFER_LOAD_FORMAT_D16_XYZW, 4, 16, false, true, true},
    {0x0cu, Opcode::TBUFFER_STORE_FORMAT_D16_X, 1, 16, false, true, true},
    {0x0du, Opcode::TBUFFER_STORE_FORMAT_D16_XY, 2, 16, false, true, true},
    {0x0eu, Opcode::TBUFFER_STORE_FORMAT_D16_XYZ, 3, 16, false, true, true},
    {0x0fu, Opcode::TBUFFER_STORE_FORMAT_D16_XYZW, 4, 16, false, true, true},
};
...
constexpr MemoryOpcodeInfo DS_OPCODE_LIST[] = {
    ...
    {0x4bu, Opcode::DS_XOR_B64, 2, 32},          {0x0bu, Opcode::DS_XOR_B32, 1, 32},
    {0x0du, Opcode::DS_WRITE_B32, 1, 32},        {0x0eu, Opcode::DS_WRITE2_B32, 2, 32},
    {0x0fu, Opcode::DS_WRITE2ST64_B32, 2, 32},   {0x12u, Opcode::DS_MIN_F32, 1, 32},
    {0x13u, Opcode::DS_MAX_F32, 1, 32},          {0x1eu, Opcode::DS_WRITE_B8, 1, 8},
    {0x1fu, Opcode::DS_WRITE_B16, 1, 16},        {0x20u, Opcode::DS_ADD_RTN_U32, 1, 32},
    {0x21u, Opcode::DS_SUB_RTN_U32, 1, 32},      {0x23u, Opcode::DS_INC_RTN_U32, 1, 32},
    {0x24u, Opcode::DS_DEC_RTN_U32, 1, 32},      {0x25u, Opcode::DS_MIN_RTN_I32, 1, 32},
    {0x26u, Opcode::DS_MAX_RTN_I32, 1, 32},      {0x27u, Opcode::DS_MIN_RTN_U32, 1, 32},
    {0x28u, Opcode::DS_MAX_RTN_U32, 1, 32},      {0x29u, Opcode::DS_AND_RTN_B32, 1, 32},
    {0x2au, Opcode::DS_OR_RTN_B32, 1, 32},       {0x2bu, Opcode::DS_XOR_RTN_B32, 1, 32},
    {0x2du, Opcode::DS_WRXCHG_RTN_B32, 1, 32},   {0x35u, Opcode::DS_SWIZZLE_B32, 1, 32},
    {0x36u, Opcode::DS_READ_B32, 1, 32},         {0x37u, Opcode::DS_READ2_B32, 2, 32},
    {0x38u, Opcode::DS_READ2ST64_B32, 2, 32},    {0x39u, Opcode::DS_READ_I8, 1, 8, true},
    {0x3au, Opcode::DS_READ_U8, 1, 8},           {0x3bu, Opcode::DS_READ_I16, 1, 16, true},
    {0x3cu, Opcode::DS_READ_U16, 1, 16},         {0x3du, Opcode::DS_CONSUME, 1, 32},
    {0x3eu, Opcode::DS_APPEND, 1, 32},           {0x4du, Opcode::DS_WRITE_B64, 2, 32},
    {0x4eu, Opcode::DS_WRITE2_B64, 4, 32},       {0x4fu, Opcode::DS_WRITE2ST64_B64, 4, 32},
    {0x76u, Opcode::DS_READ_B64, 2, 32},         {0x77u, Opcode::DS_READ2_B64, 4, 32},
    {0x78u, Opcode::DS_READ2ST64_B64, 4, 32},    {0xa1u, Opcode::DS_WRITE_B16_D16_HI, 1, 16},
    {0xa6u, Opcode::DS_READ_U16_D16, 1, 16},     {0xa7u, Opcode::DS_READ_U16_D16_HI, 1, 16},
    {0xb0u, Opcode::DS_WRITE_ADDTID_B32, 1, 32}, {0xb1u, Opcode::DS_READ_ADDTID_B32, 1, 32},
    {0xb3u, Opcode::DS_BPERMUTE_B32, 1, 32},     {0xdeu, Opcode::DS_WRITE_B96, 3, 32},
    {0xdfu, Opcode::DS_WRITE_B128, 4, 32},       {0xfeu, Opcode::DS_READ_B96, 3, 32},
    {0xffu, Opcode::DS_READ_B128, 4, 32},
};
...
// Packs a formatted D16 access into its VGPR footprint and marks the destination/source half
// the sub-dword and _HI forms touch (the other half is preserved, as for DS D16 reads).
void DecodeBufferD16(Instruction& inst) {
	if (inst.formatted && inst.data_bits == 16u) {
		inst.data_components = inst.data_dwords;
		inst.data_dwords     = (inst.data_dwords + 1u) / 2u;
	}
	switch (inst.opcode) {
